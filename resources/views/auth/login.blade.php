        ...
        <form method="POST" action="{{ route('login') }}" class="mt-6" id="login-form">
            ...
            <div class="mt-4 relative">
                ...
                <input id="password" type="password" name="password" autocomplete="current-password"
                    class="mt-1 block w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-800 dark:text-gray-200 focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none">
                <button type="button" onclick="togglePassword()" class="absolute right-3 top-9 text-gray-500 dark:text-gray-400">
    ...
    <script>
        ...
        function togglePassword() {
            ...
            if (passwordField.type === 'password') {
                ...
                eyeIcon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.269-2.943-9.542-7a10.05 10.05 0 012.967-4.763m12.045 0A10.05 10.05 0 0119.542 12c-1.273 4.057-5.064 7-9.542 7-1.076 0-2.137-.156-3.166-.456m10.833-11.57A9.97 9.97 0 0112 5c-4.477 0-8.268 2.943-9.542 7a9.97 9.97 0 002.968 4.763m12.045 0L3.343 3.343" />';
            } else {
