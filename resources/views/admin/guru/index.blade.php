                                        ...
                                        <form action="{{ route('admin.guru.update', $item->id) }}" method="POST">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="umur" value="{{ old('umur', $item->umur) }}">
...
<div class="modal fade" id="tambahGuruModal" tabindex="-1" aria-labelledby="tambahGuruModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formTambahGuru" action="{{ route('admin.guru.store') }}" method="POST">
                    @csrf
                    <!-- Nama Guru -->
                    <div class="form-group mb-3">
                        <label for="nama_guru" class="d-block">Nama Guru</label>
...
<script>
    ...
    // Jika menggunakan DataTables, pastikan variabel table dideklarasikan dengan benar
    ...
    //         info: "Menampilkan PAGE dari PAGES halaman",
    ...
    // Intersepsi submit form Tambah Guru untuk menggunakan SweetAlert
    document.getElementById('formTambahGuru').addEventListener('submit', function (e) {
        ...
        if (!nama_guru || !status || !umur || !alamat) {
            Swal.fire({
                icon: 'warning',
                title: 'Oops...',
        ...
        Swal.fire({
            title: 'Anda yakin ingin menambahkan guru?',
